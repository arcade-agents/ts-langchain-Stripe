...
ENFORCE_HUMAN_CONFIRMATION = ['Stripe_CreateBillingPortalSession', 'Stripe_CreateInvoice', 'Stripe_CreateInvoiceItem', 'Stripe_CreatePaymentLink', 'Stripe_CreateRefund', 'Stripe_FinalizeInvoice']
